...
async function main() {
  ...
  await prisma.specialist.create({
    data: {
      ...
      location: 'Симферополь, Россия (удалённо)',
      ...
      website: null,
      bio: 'Full-stack / Backend Developer. Разрабатываю бэкенд-сервисы на Node.js и NestJS с использованием TypeScript. Проектирую базы данных с Prisma ORM и строю гибкие API-слои на GraphQL и REST. Настраиваю воспроизводимую сборку и деплой через Docker и Docker Compose. Использую Claude Code как AI-ассистента для ускорения рутины, написания тестов и отладки контейнеризованных окружений.',
      skills: {
        create: [
        ...
        create: [
          {
            ...
            repoUrl: 'https://github.com/Konstantinbadto/bisness-card',
